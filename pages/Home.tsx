...
const Home: React.FC = () => {
  ...
  const { ref: magRef1, style: magStyle1 } = useMagnetic(20);
  const { ref: magRef2, style: magStyle2 } = useMagnetic(10);
  ...
  return (
    <div className="pt-24 min-h-screen">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] left-[-10%] w-[60%] h-[60%] bg-blue-100 rounded-full blur-[150px] opacity-60"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-sky-50 rounded-full blur-[120px] opacity-60"></div>
      </div>
      ...
      <section className="container mx-auto px-6 py-12 lg:py-24 relative overflow-hidden">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          <div className="lg:w-1/2 z-10 text-center lg:text-left reveal active">
            <div className="inline-flex items-center space-x-2 px-5 py-2.5 rounded-full bg-white border-2 border-[#4FACFE]/40 text-[10px] font-black uppercase tracking-widest text-[#0A2540] mb-8 shadow-xl">
              <span className="relative flex h-2.5 w-2.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#4FACFE] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#4FACFE]"></span>
              </span>
            ...
            <p className="text-xl text-[#374151] mb-12 max-w-xl mx-auto lg:mx-0 leading-relaxed font-semibold reveal active stagger-2">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 reveal active stagger-3">
              <div ref={magRef1} style={magStyle1} className="magnetic-wrap w-full sm:w-auto">
                <a 
                  href="#/contact" 
                  className="w-full sm:w-auto bg-[#0A2540] text-white px-12 py-5 rounded-2xl font-black text-center flex items-center justify-center transition-all shadow-2xl hover:scale-105 active:scale-95 relative overflow-hidden group tracking-[0.2em] uppercase text-xs"
                >
                  <span className="relative z-10 flex items-center">Initialize project <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" /></span>
                </a>
              </div>
              <div ref={magRef2} style={magStyle2} className="magnetic-wrap w-full sm:w-auto">
                <a 
                  href="#/services" 
                  className="w-full sm:w-auto bg-white border-2 border-[#4FACFE] text-[#0A2540] px-12 py-5 rounded-2xl font-black text-xs tracking-[0.2em] uppercase text-center hover:shadow-2xl transition-all flex items-center justify-center backdrop-blur-sm"
                >
                  View Capabilities
                </a>
              </div>
          ...
          <div className="lg:w-1/2 relative h-[400px] md:h-[600px] w-full flex items-center justify-center perspective-1000 reveal active stagger-2">
            <div 
            ...
            >
              <svg viewBox="0 0 200 200" className="w-full h-full animate-float">
                ...
                <circle cx="100" cy="100" r="80" fill="url(#orbGrad)" opacity="0.15" stroke="#4FACFE" strokeWidth="0.5" />
                ...
                <g className="animate-spin" style={{ transformOrigin: 'center', animationDuration: '12s' }}>
                  <ellipse cx="100" cy="100" rx="90" ry="35" fill="none" stroke="#4FACFE" strokeWidth="0.4" opacity="0.6" />
                </g>
                <g className="animate-spin" style={{ transformOrigin: 'center', animationDuration: '18s', animationDirection: 'reverse' }}>
                  <ellipse cx="100" cy="100" rx="35" ry="90" fill="none" stroke="#0061FF" strokeWidth="0.4" opacity="0.6" />
                </g>
                ...
                {[0, 90, 180, 270].map((deg, i) => {
                  ...
                  return (
                    <circle key={i} cx={x} cy={y} r="3" fill="#4FACFE">
                      <animate attributeName="opacity" values="0.3;1;0.3" dur="4s" begin={`${i}s`} repeatCount="indefinite" />
                    </circle>
                  );
                })}
              </svg>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                 <div className="w-40 h-40 bg-white rounded-[3rem] border-4 border-white shadow-2xl flex items-center justify-center overflow-hidden group">
                    <div className="w-20 h-20 bg-gradient-to-br from-[#4FACFE] to-[#0061FF] rounded-3xl flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform duration-500">
      ...
      <section className="py-32" id="services">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {SERVICES.slice(0, 9).map((service, idx) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 bg-blue-50 border border-blue-100 rounded-[1.5rem] flex items-center justify-center mb-10 group-hover:bg-[#4FACFE] group-hover:text-white transition-all duration-500 shadow-sm relative z-10">
          ...
          <div className="mt-20 text-center reveal active">
             <a href="#/services" className="inline-flex items-center font-black text-xs tracking-widest uppercase text-[#4FACFE] group py-5 px-10 bg-white border-2 border-[#4FACFE] rounded-2xl hover:bg-[#4FACFE] hover:text-white transition-all shadow-lg">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            {CASE_STUDIES.slice(0, 3).map((study, i) => (
              <div key={i} className="reveal group flex flex-col h-full bg-white border-2 border-white rounded-[3rem] p-12 shadow-xl hover:shadow-2xl transition-all duration-500 active stagger-1 overflow-hidden">
                <div className="text-[10px] font-black text-[#0A2540] bg-blue-100 border border-blue-200 px-4 py-2 rounded-full uppercase tracking-widest mb-10 inline-flex self-start items-center">
                  <span className="w-2.5 h-2.5 rounded-full bg-gradient-to-r from-[#4FACFE] to-[#0061FF] mr-2.5"></span>
                  {study.category}
                </div>
                ...
                <div className="space-y-6 flex-grow">
                   ...
                   <div className="flex flex-wrap gap-2">
                     {study.techStack.map((tech, tIdx) => (
                        <span key={tIdx} className="px-4 py-1.5 bg-blue-50 text-[10px] font-black text-[#4FACFE] rounded-xl border border-blue-100 uppercase">{tech}</span>
                     ))}
                   </div>
                </div>
            ...
            {TESTIMONIALS.map((t, i) => (
              <div key={i} className="reveal soft-card p-12 border-2 border-white active bg-white" style={{ transitionDelay: `${i * 100}ms` }}>
                <div className="flex items-center space-x-6 mb-10">
                  <img src={t.image} alt={t.name} className="w-16 h-16 rounded-[1.5rem] object-cover border-2 border-white shadow-md" />
                  <div>
      ...
      <section className="py-32">
        <div className="container mx-auto px-6">
          <div className="relative bg-[#0A2540] rounded-[4rem] p-16 md:p-32 text-center text-white shadow-3xl overflow-hidden group border-4 border-white">
            <div className="relative z-10">
              ...
              <div className="flex flex-col md:flex-row justify-center items-center gap-8 reveal active stagger-2">
                 <a 
                   href="#/contact" 
                   className="w-full md:w-auto bg-white text-[#0A2540] px-16 py-7 rounded-[2.5rem] font-black text-xl flex items-center justify-center hover:scale-105 active:scale-95 transition-all shadow-4xl uppercase tracking-[0.2em]"
                 >
